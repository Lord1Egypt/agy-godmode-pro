...
`bin/agy-next-version` utility `/ship` uses, but with nothing mutating.
Think of it as `gh pr list` for VERSION numbers.


## Step 1: Detect platform and base branch

Same detection as other agy skills.
