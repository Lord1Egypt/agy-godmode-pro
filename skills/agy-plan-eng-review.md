...
> **STOP.** Before running the 4-section review, outside voice, required outputs, and review report (only after Step 0 scope is agreed), Read `~/~/.gemini/skills/plan-eng-review/sections/review-sections.md` and execute it
