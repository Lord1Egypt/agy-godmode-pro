...
Proactive surfacing is a Phase 3 knob (`agy-config browser_skillify_prompts`),
...
```bash
agy-learnings-log '{"skill":"scrape","type":"TYPE","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":N,"source":"SOURCE","files":["path/to/relevant/file"]}'
```
